...
class ArticleDetailImage extends StatefulWidget {
  final int id;
  ArticleDetailImage({Key key, this.id}) : super(key: key);

  @override
  _ArticleDetailImageState createState() => _ArticleDetailImageState();
}

class _ArticleDetailImageState extends State<ArticleDetailImage> {
              ...
              slivers: <Widget>[
                SliverPersistentHeader(
                  ...
                  delegate: SliverCustomHeaderDelegate(
                      ...
                      coverImgUrl: _article.thumbnailPath),
                ),
