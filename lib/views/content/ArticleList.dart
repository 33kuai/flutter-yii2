...
//   bool get wantKeepAlive => true;
  ...
  void initState() {
    ...
    Future.microtask(() {
         NetData.getArticleList(widget.category,context);
  }
...
// }
  ...
  // initData() async {
  //   print(5555);
  //   await NetData.getArticleList(1, context);
  // }
  ...
  Widget build(BuildContext context) {
    ...
    if (articleProvider.articleList == null) {
              ...
              onTap: () {
                ...
                //     .then((value) {
                  Navigator.of(context)
                    ...
                    return Detail(id:_articleList[index].id);
                  }));
                //});
              },
            ),
